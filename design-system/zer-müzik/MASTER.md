...
| Muted | `#F5F0E8` | `--color-muted` |
| Card | `#FFFFFF` | `--color-card` |
| Border | `#E8E0D5` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#171717` | `--color-ring` |

**Color Notes:** Warm ivory/cream white background `#FFFBF5` with pure white cards `#FFFFFF`, near-black foreground `#171717`, and gold accent `#A16207` for a premium luthier/craft feel. Accent adjusted from `#D4AF37` for WCAG 3:1.
